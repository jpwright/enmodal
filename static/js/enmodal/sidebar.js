class Sidebar {
    ...
    refresh_line_editor() {
        ...
        $('#custom-line-marker').css('background-color', enmodal.transit_interface.active_line.color_bg);
        $('#custom-line-marker').css('color', enmodal.transit_interface.active_line.color_fg);
    ...
    service_selector_new() {
        ...
        this.update_service_selector(service.sid);
        enmodal.transit_interface.active_line = null;
